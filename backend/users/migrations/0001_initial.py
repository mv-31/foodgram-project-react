    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Имя пользователя', max_length=150, unique=True, verbose_name='Логин')),
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('admin', 'admin'), ('is_blocked', 'is_blocked')], default='user', help_text='Права пользователя', max_length=20, verbose_name='Роль')),
                ('password', models.CharField(help_text='Пароль', max_length=100, null=True)),
